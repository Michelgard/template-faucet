                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <?= form_input(array('name'=>'param_solve_media_Challenge_Key', 'class'=>'form-control', 'value'=>$param_solve_media_Challenge_Key))?>
                            </div>
                            <div class="form-group">
                                <?=form_label('Solve Media Verification Key (V-key)', 'param_solve_media_Verification_Key');?><br/>
                                <?= form_input(array('name'=>'param_solve_media_Verification_Key', 'class'=>'form-control', 'value'=>$param_solve_media_Verification_Key))?>
                            </div>
                            <div class="form-group">
                                <?=form_label('Solve Media Authentication Hash Key (H-key)', 'param_solve_media_Authentication_Hash_Key');?><br/>
                                <?= form_input(array('name'=>'param_solve_media_Authentication_Hash_Key', 'class'=>'form-control', 'value'=>$param_solve_media_Authentication_Hash_Key))?>
                            </div>
                        </div>
                    </div>
                    <div class="box box-primary">
